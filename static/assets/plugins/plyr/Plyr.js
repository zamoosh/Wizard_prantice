...
<!--                         <form name="set_tip"> -->
                            ...
                            <div class="mb-3">
                                ...
                                <button type="button" name="save" class="btn btn-primary btn-sm">save</button>
                            </div>
<!--                         </form> -->
                    </div>
                </div>
    ...
    enableAddingMarker() {
        ...
        let save_btn = document.querySelector('button[name="save"]');
        save_btn.addEventListener('click', function () {
            player.setMarker(tip.value);
            tip.value = '';
